package com.example.hsxfd.cyzim.config.preference;
...
import com.example.hsxfd.cyzim.AppCache;
import com.example.hsxfd.cyzim.StatusBarNotificationConfig;
...
public class UserPreferences {
    ...
    static SharedPreferences getSharedPreferences() {
        return AppCache.getContext().getSharedPreferences("Demo." + AppCache.getAccount(), Context.MODE_PRIVATE);
    }
}
